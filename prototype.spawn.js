...
Game.spawns.W7S8.memory.minCreeps = {harvester: 1, rampartrepairer: 2};
...
//if (Game.time % 50 === 0) {
    Game.spawns.W7S8.memory.minhealers = {W9S6: 0};
//}
...
Game.spawns.Spawn2.memory.minLongDistanceHarvesters = {W2S8: 2}
Game.spawns.Spawn4.memory.minCreeps = {harvester: 0, builder: 1, repairer: 0, upgrader: 0}
...
Game.spawns.Spawn3.memory.minCreeps = {harvester: 1, repairer: 0, builder: 0, lorry: 1, wallRepairer: 0,
                                       towerlorry: 1, upgrader: 0, rampartrepairer: 2, dismantler: 0};
...
if (Game.time % 1000 === 0) {
Game.spawns.Spawn1.memory.mintowerdrainers1 = {W9S6: 0}
}
